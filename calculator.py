...
class Pycal(QMainWindow):
    ...
    def create_widget(self):
        ...
        btn1.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for 2
        btn2 = QPushButton("2", self)
        btn2.setGeometry(95,150,80,40)
        btn2.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for 3
        btn3 = QPushButton("3", self)
        btn3.setGeometry(185,150,80,40)
        btn3.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for operator (*)
        btn_mul = QPushButton("*", self)
        btn_mul.setGeometry(275,150,80,40)
        btn_mul.setStyleSheet("background: #E0FFFF;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for 4
        btn4 = QPushButton("4", self)
        btn4.setGeometry(5,200,80,40)
        btn4.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for 5
        btn5 = QPushButton("5", self)
        btn5.setGeometry(95,200,80,40)
        btn5.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for 6
        btn6 = QPushButton("6", self)
        btn6.setGeometry(185,200,80,40)
        btn6.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for operator (-)
        btn_minus = QPushButton("-", self)
        btn_minus.setGeometry(275,200,80,40)
        btn_minus.setStyleSheet("background: #E0FFFF;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for 7
        btn7 = QPushButton("7", self)
        btn7.setGeometry(5,250,80,40)
        btn7.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for 8
        btn8 = QPushButton("8", self)
        btn8.setGeometry(95,250,80,40)
        btn8.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for 9
        btn9 = QPushButton("9", self)
        btn9.setGeometry(185,250,80,40)
        btn9.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for operator (+)
        btn_plus = QPushButton("+", self)
        btn_plus.setGeometry(275,250,80,40)
        btn_plus.setStyleSheet("background: #E0FFFF;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for 0
        btn0 = QPushButton("0", self)
        btn0.setGeometry(5,300,80,40)
        btn0.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for point(.)
        btn_point = QPushButton(".", self)
        btn_point.setGeometry(95,300,80,40)
        btn_point.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for operator (/)
        btn_div = QPushButton("/", self)
        btn_div.setGeometry(185,300,80,40)
        btn_div.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black" "border: 2px solid brown")
        
        #create button for operator (=)
        btn_equal = QPushButton("=", self)
        btn_equal.setGeometry(275,300,80,40)
        btn_equal.setStyleSheet("background: #E0FFFF;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for open bracket
        btn_open = QPushButton("(", self)
        btn_open.setGeometry(5,100,80,40)
        btn_open.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for close bracket
        btn_close = QPushButton(")", self)
        btn_close.setGeometry(95,100,80,40)
        btn_close.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for Clear
        btn_clear = QPushButton("Clear", self)
        btn_clear.setGeometry(185,100,80,40)
        btn_clear.setStyleSheet("background: #AAFFAA;""font-size: 20px;" "color: black;" "border: 2px solid brown")
        
        #create button for Del
        btn_del = QPushButton("Del", self)
        btn_del.setGeometry(275,100,80,40)
        btn_del.setStyleSheet("background: #E0FFFF;""font-size: 20px;" "color: black;" "border: 2px solid brown")
